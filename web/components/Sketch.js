...
function sketch(p5) {
  ...
  var leafSq = function (x, y, w, h, t) {
    p5.push();
    p5.translate(x - w / 2, y - h / 2);
    let diagonal = ~~(Math.sqrt(w * w + h * h) * 0.2);
    p5.fill(86, 125, 86);
    p5.rect(0, 0, w, h, diagonal);
    p5.fill(131, 187, 113);
    p5.rect(0, 0, w, h / 2, diagonal, diagonal, 0, 0);
    p5.pop();
  };
  ...
  var tree5 = function (x, y) {
    ...
    bark(30, 235, 11, 63, 0);
    fin1(67, 282, 62, 88, p5.color(79, 115, 78), p5.color(63, 92, 69));
    jagged(67, 282, 62, 88, p5.color(89, 141, 95), p5.color(77, 115, 78), 1.55);
    jagged(67, 282, 62, 88, p5.color(116, 175, 94), p5.color(88, 142, 90), 1.0);
  ...
  var tree6 = function (x, y) {
    ...
    p5.translate(x - 35, y - 300);
    bark(30, 238, 11, 63, 0);
    fin1(75, 282, 77, 48, p5.color(79, 115, 78), p5.color(63, 92, 69));
    fin1(62, 254, 52, 40, p5.color(89, 141, 95), p5.color(77, 115, 78));
    fin1(52.5, 226, 33, 22, p5.color(116, 175, 94), p5.color(88, 142, 90));
